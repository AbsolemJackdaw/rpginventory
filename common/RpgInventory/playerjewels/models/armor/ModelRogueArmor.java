...
public class ModelRogueArmor extends ModelBiped
{
	...
	public ModelRogueArmor(float par1, float par2, int par3, int par4)
	{
		...
		ToetipR.addBox(-2F, 10F, -3F, 4, 2, 1,par1);
		...
		bipedRightLeg.addChild(ToetipL);
