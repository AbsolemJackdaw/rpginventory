...
public class RenderPlayerJewels extends RenderPlayer {
	...
	public void doRender(Entity par1EntityPlayer, double par2, double par4, double par6, float par8, float par9) {
		Field fieldPlayerModel = null, fieldArmorModel = null, fieldarmorModelC = null;
		try {
		...
		try {
			for(ItemStack is: ModelBeastArmor.armor){
				if(is!= null){     
...
//						}
//						if(is.getItem().itemID == mod_RpgInventory.beastChest.itemID){
//							//fieldArmorModel.set(render, new ModelBeastArmor(0.5F, 0.0F, 64, 32));
//							fieldarmorModelC.set(render, new ModelBeastArmor(1.0F, 0.0F, 64, 32));
//						}
//						if(is.getItem().itemID == mod_RpgInventory.beastLegs.itemID){
//							fieldArmorModel.set(render, new ModelBeastArmor(0.5F, 0.0F, 64, 32));
//							//fieldarmorModelC.set(render, new ModelBeastArmor(1.0F, 0.0F, 64, 32));
//						}
//						if(is.getItem().itemID == mod_RpgInventory.beastBoots.itemID){
////							fieldArmorModel.set(render, new ModelBeastArmor(0.5F, 0.0F, 64, 32));
//							fieldarmorModelC.set(render, new ModelBeastArmor(1.0F, 0.0F, 64, 32));
//						}
//					}
