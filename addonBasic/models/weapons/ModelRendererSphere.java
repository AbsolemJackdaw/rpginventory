...
public class ModelRendererSphere extends ModelRenderer {
	...
	public ModelRenderer addSphere(float par1, float par2, float par3,
			int par4, int par5, int par6) {
		this.cubeList.add(new ModelSphere(this, this.textureOffsetX,
				this.textureOffsetY, par1, par2, par3, par4, par5, par6, 0.0F));
		return this;
	}
