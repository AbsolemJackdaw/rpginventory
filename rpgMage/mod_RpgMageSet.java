...
public class mod_RpgMageSet {
	...
	public  final static EnumArmorMaterial archMage = EnumHelper.addArmorMaterial("archmage", 20, new int[]{4, 4, 4, 2}, 5);
	...
	public void load(FMLInitializationEvent event) {
		...
		archmageLegs = new ItemMageARmor(RpgConfig.instance.archmageLegs, archMage, 4, 2).setUnlocalizedName("archMage3");
		archMageBoots = new ItemMageARmor(RpgConfig.instance.archmageBoots, archMage, 4, 3).setUnlocalizedName("archMage4");
		...
		GameRegistry.addRecipe(new ItemStack(windStaff), new Object[]{"III", "DSD", "III", 'I', Item.feather, 'D', Item.diamond, 'S', mod_RpgInventory.staf});
		GameRegistry.addRecipe(new ItemStack(frostStaff), new Object[]{"III", "DSD", "III", 'I', Block.ice, 'D', Item.diamond, 'S', mod_RpgInventory.staf});
		GameRegistry.addRecipe(new ItemStack(earthStaff), new Object[]{"III", "DSD", "III", 'I', Block.grass, 'D', Item.diamond, 'S', mod_RpgInventory.staf});
		GameRegistry.addRecipe(new ItemStack(fireStaff), new Object[]{"III", "DSD", "III", 'I', Item.blazePowder, 'D', Item.diamond, 'S', mod_RpgInventory.staf});
		GameRegistry.addRecipe(new ItemStack(archBook), new Object[]{"III", "IBI", " I ", 'I', new ItemStack(Item.dyePowder, 1, 4), 'B', Item.book});
		GameRegistry.addRecipe(new ItemStack(archMageBoots), new Object[]{"III", "IBI", "III", 'B', mod_RpgInventory.mageboots, 'I', Item.goldNugget});
		GameRegistry.addRecipe(new ItemStack(archmageLegs), new Object[]{"III", "IBI", "III", 'B', mod_RpgInventory.magepants, 'I', Item.goldNugget});
		GameRegistry.addRecipe(new ItemStack(archmageChest), new Object[]{"III", "IBI", "III", 'B', mod_RpgInventory.magegown, 'I', Item.goldNugget});
		GameRegistry.addRecipe(new ItemStack(archmageHood), new Object[]{"III", "IBI", "III", 'B', mod_RpgInventory.magehood, 'I', Item.goldNugget});
