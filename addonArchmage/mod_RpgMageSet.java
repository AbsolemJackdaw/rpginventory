...
public class mod_RpgMageSet {
	...
	public void preInit(FMLPreInitializationEvent e){
		...
		allItems = new Item[]{
				archBook, fireStaff, frostStaff, earthStaff, windStaff,
				ultimateStaff, archmageHood, archmageChest, archmageLegs,
				archMageBoots, archMageLeather
		};
		for (int i = 0; i < allItems.length; i++) {
			...
			if (allItems[i] != null) {
				...
				allItems[i].setTextureName(id + ":"	+ name);
				
				GameRegistry.registerItem(allItems[i],	allItems[i].getUnlocalizedName(), name);
