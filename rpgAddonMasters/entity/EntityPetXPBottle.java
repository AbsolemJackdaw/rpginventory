 ...
 */
package rpgAddonMasters.entity;
...
public class EntityPetXPBottle extends EntityExpBottle {
	...
	public EntityPetXPBottle(World par1World, double par2, double par4,
			double par6) {
	...
	protected void onImpact(MovingObjectPosition par1MovingObjectPosition) {
		if (!this.worldObj.isRemote) {
			...
			while (i > 0) {
				...
				i -= j;
				this.worldObj.spawnEntityInWorld(new EntityPetXP(this.worldObj,
