...
public class RpgRBPacketPipeline17 extends
		MessageToMessageCodec<FMLProxyPacket, RpgRBAbstractPacket> {

	private EnumMap<Side, FMLEmbeddedChannel> channels;
	private LinkedList<Class<? extends RpgRBAbstractPacket>> packets = new LinkedList<Class<? extends RpgRBAbstractPacket>>();
	...
	@Override
	protected void encode(ChannelHandlerContext ctx, RpgRBAbstractPacket msg,
			List<Object> out) throws Exception {
		ByteBuf buffer = Unpooled.buffer();
		Class<? extends RpgRBAbstractPacket> clazz = msg.getClass();
	...
	protected void decode(ChannelHandlerContext ctx, FMLProxyPacket msg,
		...
		Class<? extends RpgRBAbstractPacket> clazz = this.packets.get(discriminator);
		if (clazz == null) {
			throw new NullPointerException(
					"No packet registered for discriminator: " + discriminator);
		}

		RpgRBAbstractPacket pkt = clazz.newInstance();
	...
	public void postInitialise() {
		...
		Collections.sort(this.packets,
				new Comparator<Class<? extends RpgRBAbstractPacket>>() {

					@Override
					public int compare(Class<? extends RpgRBAbstractPacket> clazz1,
							Class<? extends RpgRBAbstractPacket> clazz2) {
	 ...
	 *            The message to send
	 */
	public void sendToAll(RpgRBAbstractPacket message) {
	 ...
	 */
	public void sendTo(RpgRBAbstractPacket message, EntityPlayerMP player) {
		this.channels.get(Side.SERVER)
				.attr(FMLOutboundHandler.FML_MESSAGETARGET)
	 ...
	 */
	public void sendToAllAround(RpgRBAbstractPacket message,
	 ...
	 */
	public void sendToDimension(RpgRBAbstractPacket message, int dimensionId) {
		this.channels.get(Side.SERVER)
				.attr(FMLOutboundHandler.FML_MESSAGETARGET)
	 ...
	 *            The message to send
	 */
	public void sendToServer(RpgRBAbstractPacket message) {
