...
public class RpgConfig {
	...
	private void loadBlocks(Configuration config) {
		...
		// forgeblockID = config.getBlock("forgeblock",
		// blocknum).getInt(blocknum);
		blocknum++;
	}
	...
	private void loadItems(Configuration config) {
		...
		// itemnum++;
		// glovesbutterID = config.getItem("glovesbutter", itemnum)
		// .getInt(itemnum);
		// itemnum++;
		...
		//
		// itemnum++;
		// archersShieldID = config.getItem("archersShield", itemnum).getInt(
		// itemnum);
		//
		// itemnum++;
		// berserkerShieldID = config.getItem("berserkerShield",
		// itemnum).getInt(
		// itemnum);
		//
		// itemnum++;
		...
		//
		// itemnum++;
		// pala_shieldID = config.getItem("pala_shield",
		// itemnum).getInt(itemnum);
		//
		// itemnum++;
		// necro_shieldID = config.getItem("necro_shield", itemnum)
		// .getInt(itemnum);
		//
		// itemnum++;
		...
		//
		// itemnum++;
		// shieldDiamondID = config.getItem("shieldDiamond", itemnum).getInt(
		// itemnum);
		//
		// itemnum++;
		...
		//
		// itemnum++;
		// cloakYellowID = config.getItem("cloakYellow",
		// itemnum).getInt(itemnum);
		//
		// itemnum++;
		...
		// itemnum++;
		// archerchestID = config.getItem("archerchest",
		// itemnum).getInt(itemnum);
		// itemnum++;
		// archerpantsID = config.getItem("archerpants",
		// itemnum).getInt(itemnum);
		// itemnum++;
		// archerbootsID = config.getItem("archerboots",
		// itemnum).getInt(itemnum);
		// itemnum++;
		// berserkerHoodID = config.getItem("berserkerHood", itemnum).getInt(
		// itemnum);
		// itemnum++;
		// berserkerChestID = config.getItem("berserkerChest", itemnum).getInt(
		// itemnum);
		// itemnum++;
		// berserkerLegsID = config.getItem("berserkerLegs", itemnum).getInt(
		// itemnum);
		// itemnum++;
		// berserkerBootsID = config.getItem("berserkerBoots", itemnum).getInt(
		// itemnum);
		// itemnum++;
		// necroHoodID = config.getItem("necroHood", itemnum).getInt(itemnum);
		// itemnum++;
		// necroChestplateID = config.getItem("necroChestplate",
		// itemnum).getInt(
		// itemnum);
		// itemnum++;
		// necroLeggingsID = config.getItem("necroLeggings", itemnum).getInt(
		// itemnum);
		// itemnum++;
		...
		// itemnum++;
		// palaLeggingsID = config.getItem("palaLeggings", itemnum)
		// .getInt(itemnum);
		// itemnum++;
		// palaBootsID = config.getItem("palaBoots", itemnum).getInt(itemnum);
		// itemnum++;
		// pala_weaponID = config.getItem("pala_weapon",
		// itemnum).getInt(itemnum);
		// itemnum++;
		...
		// itemnum++;
		// necro_weaponID = config.getItem("necro_weapon", itemnum)
		// .getInt(itemnum);
		// itemnum++;
		...
		// itemnum++;
		// rogueLeatherID = config.getItem("rogueLeather", itemnum)
		// .getInt(itemnum);
		// itemnum++;
		// beastLeatherID = config.getItem("beastLeather", itemnum)
		// .getInt(itemnum);
		// itemnum++;
		...
		// itemnum++;
		// staffUltimate = config.getItem("staffUltimate", itemnum)
		// .getInt(itemnum);
		// itemnum++;
		...
		// itemnum++;
		// archmageHood = config.getItem("archmageHood",
		// itemnum).getInt(itemnum);
		// itemnum++;
		// archmageChest = config.getItem("archmageChest", itemnum)
		// .getInt(itemnum);
		// itemnum++;
		// archmageLegs = config.getItem("archmageLegs",
		// itemnum).getInt(itemnum);
		// itemnum++;
		// archmageBoots = config.getItem("archmageBoots", itemnum)
		// .getInt(itemnum);
		// itemnum++;
