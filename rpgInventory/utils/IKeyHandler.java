...
public interface IKeyHandler {
	...
	static KeyBinding keyInventory = new KeyBinding("RPG Inventory Key", Keyboard.KEY_END);
	static KeyBinding keySpecial = new KeyBinding("RPG Special Ability", Keyboard.KEY_F);
