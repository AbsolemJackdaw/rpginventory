...
public class MoldRecipes {
	...
	private MoldRecipes() {
		...
		addRecipe(new ItemStack(mod_RpgInventory.ringmold), new ItemStack(
				Item.ingotGold), new ItemStack(mod_RpgInventory.ringgold), 0.7F);
		addRecipe(new ItemStack(mod_RpgInventory.ringmold), new ItemStack(
				Item.emerald), new ItemStack(mod_RpgInventory.ringem), 0.7F);
		addRecipe(new ItemStack(mod_RpgInventory.ringmold), new ItemStack(
				Item.diamond), new ItemStack(mod_RpgInventory.ringdia), 0.7F);
		addRecipe(new ItemStack(mod_RpgInventory.ringmold), new ItemStack(
				Item.dyePowder, 1, 4), new ItemStack(mod_RpgInventory.ringlap),
				0.7F);

		addRecipe(new ItemStack(mod_RpgInventory.colmold), new ItemStack(
				Item.ingotGold), new ItemStack(mod_RpgInventory.neckgold), 0.7F);
		addRecipe(new ItemStack(mod_RpgInventory.colmold), new ItemStack(
				Item.emerald), new ItemStack(mod_RpgInventory.neckem), 0.7F);
		addRecipe(new ItemStack(mod_RpgInventory.colmold), new ItemStack(
				Item.diamond), new ItemStack(mod_RpgInventory.neckdia), 0.7F);
		addRecipe(new ItemStack(mod_RpgInventory.colmold), new ItemStack(
				Item.dyePowder, 1, 4), new ItemStack(mod_RpgInventory.necklap),
				0.7F);

		addRecipe(new ItemStack(mod_RpgInventory.wantmold), new ItemStack(
				Item.ingotGold), new ItemStack(mod_RpgInventory.glovesbutter),
				0.7F);
		addRecipe(new ItemStack(mod_RpgInventory.wantmold), new ItemStack(
				Item.emerald), new ItemStack(mod_RpgInventory.glovesem), 0.7F);
		addRecipe(new ItemStack(mod_RpgInventory.wantmold), new ItemStack(
				Item.diamond), new ItemStack(mod_RpgInventory.glovesdia), 0.7F);
		addRecipe(new ItemStack(mod_RpgInventory.wantmold), new ItemStack(
				Item.dyePowder, 1, 4),
	...
	public void addRecipe(ItemStack item, ItemStack item2, ItemStack stack,
			float experience) {
