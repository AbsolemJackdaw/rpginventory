...
import rpgInventory.TextureIDs;
...
public class GuiMF extends GuiContainer {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, TextureIDs.texForgeGuiID);
        int j = (width - xSize) / 2;
        ...
        float x = 1 * ratio;
        float y = 6 * ratio;
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, TextureIDs.texRpgInvTMID);
        Tessellator.instance.textureID = TextureIDs.texRpgInvTMID;
