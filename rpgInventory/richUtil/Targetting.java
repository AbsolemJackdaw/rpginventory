...
public class Targetting {
	...
	public static EntityLivingBase isTargetingLivingEntity(double parDistance) {
		...
		if (viewEntity != null) {
			...
			MovingObjectPosition objectMouseOver = viewEntity.rayTrace(
					parDistance, 0.5F);
			...
			Vec3 lookFarCoord = playerPosition.addVector(dirVec.xCoord
					* parDistance, dirVec.yCoord * parDistance, dirVec.zCoord
					* parDistance);

			List<EntityLivingBase> targettedEntities = worldObj
					.getEntitiesWithinAABB(
							EntityLivingBase.class,
							viewEntity.boundingBox.addCoord(
